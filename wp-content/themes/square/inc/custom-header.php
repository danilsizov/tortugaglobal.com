 ...
 * @uses square_admin_header_style()
...
function square_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'square_custom_header_args', array(
		...
		'admin-head-callback'    => 'square_admin_header_style',
		'admin-preview-callback' => 'square_admin_header_image',
	) ) );
}
...
if ( ! function_exists( 'square_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see square_custom_header_setup().
 */
function square_admin_header_style() {
?>
	<style type="text/css">
...
endif; // square_admin_header_style

if ( ! function_exists( 'square_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see square_custom_header_setup().
 */
function square_admin_header_image() {
?>
	<div id="headimg">
...
endif; // square_admin_header_image
